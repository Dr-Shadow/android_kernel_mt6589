...
void OV5648MIPI_Set_Mirror_Flip(kal_uint8 image_mirror)
{
    ...
    /********************************************************
       ...
       *
       ********************************************************/
#if defined(PROJECT_E960_PCB_V4) ||defined(PROJECT_E960_PCB_V3) || defined(PROJECT_E960_PCB_V2) || defined(PROJECT_E960_PCB_V1)
/* because 4e1 hv mirror with 5648 */
	switch (image_mirror)
	{
		case IMAGE_NORMAL:
                      ...
                      MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    OV5648MIPI_Set_Mirror_Flip(sensor_config_data->SensorImageMirror); //opened by hongzhe
                          ...
                          MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    // rotate it 180 degree
    //sensor_config_data->SensorImageMirror = IMAGE_HV_MIRROR;
    OV5648MIPI_Set_Mirror_Flip(sensor_config_data->SensorImageMirror); //hongzhe opened 
