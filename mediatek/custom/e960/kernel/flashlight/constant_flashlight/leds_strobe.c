...
#if defined(PROJECT_E960_PCB_V1) || defined(PROJECT_E960_PCB_V2) || defined(PROJECT_E960_PCB_V3) || defined(PROJECT_E960_PCB_V4)
//#define GPIO_CAMERA_FLASH_MODE_PIN GPIO95
//#define GPIO_CAMERA_FLASH_MODE_PIN_M_GPIO  GPIO_MODE_00
    /*CAMERA-FLASH-T/F
           H:flash mode
           L:torch mode*/
//#define GPIO_CAMERA_FLASH_EN_PIN GPIO46
//#define GPIO_CAMERA_FLASH_EN_PIN_M_GPIO  GPIO_MODE_00
    /*CAMERA-FLASH-EN */


int gpio_FL_Init(void)
{
    /*set torch mode*/
    ...
    /*Init. to disable*/
    if(mt_set_gpio_mode(GPIO_CAMERA_FLASH_EN_PIN,GPIO_CAMERA_FLASH_MODE_PIN_M_GPIO)){PK_DBG("[constant_flashlight] set gpio mode failed!! \n");}
...
int gpio_FL_Uninit(void)
{
    /*Uninit. to disable*/
#if defined(PROJECT_E960_PCB_V2) 
    if(mt_set_gpio_mode(GPIO_CAMERA_FLASH_MODE_PIN,GPIO_CAMERA_FLASH_MODE_PIN_M_GPIO)){PK_DBG("[constant_flashlight] set gpio mode failed!! \n");}
    if(mt_set_gpio_dir(GPIO_CAMERA_FLASH_MODE_PIN,GPIO_DIR_OUT)){PK_DBG("[constant_flashlight] set gpio dir failed!! \n");}
    if(mt_set_gpio_out(GPIO_CAMERA_FLASH_MODE_PIN,GPIO_OUT_ZERO)){PK_DBG("[constant_flashlight] set gpio failed!! \n");}
#else
...
int gpio_FL_dim_duty(kal_uint32 duty)
{
    /*N/A*/
...
int gpio_FL_step(kal_uint32 step)
{
