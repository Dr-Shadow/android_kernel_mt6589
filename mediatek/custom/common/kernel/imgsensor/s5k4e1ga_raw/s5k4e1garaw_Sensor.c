...
// 0x6e, 0x20, 0x30, 0x6c
#define S5K4E1GA_WRITE_ID_1   0x20
#define S5K4E1GA_WRITE_ID_2   0x6e


u16 S5K4E1GA_WRITE_ID = S5K4E1GA_WRITE_ID_1;
u16 S5K4E1GA_READ_ID = S5K4E1GA_WRITE_ID_1+1;
...
#define S5K4E1GA_write_cmos_sensor_v2(addr, para) iWriteReg((u16) addr , (u32) para , 1, S5K4E1GA_WRITE_ID_2)

kal_uint16 S5K4E1GA_read_cmos_sensor_v2(kal_uint32 addr)
{
	kal_uint16 get_byte=0;
    	iReadReg((u16) addr ,(u8*)&get_byte,S5K4E1GA_WRITE_ID_2);
   	 return get_byte;
}
...
void S5K4E1GA_write_shutter(kal_uint16 shutter)
{
	...
	s5k4e1ga.maxExposureLines = frame_length ; //4  //8
...
/////////////////////////////////////////////
//yanglin test
 //S5K4E1GA_write_cmos_sensor(0x3, 0x06);	//RAW 10
 S5K4E1GA_write_cmos_sensor(0x3112, 0x01);
S5K4E1GA_write_cmos_sensor(0x3030, 0x05); //20121022 07
///////////////////////////////////////////////
...
S5K4E1GA_write_cmos_sensor(0x3119,0x0A);//0A
S5K4E1GA_write_cmos_sensor(0x311A,0xAA);//AA
...
// S5K4E1GA_write_cmos_sensor(0x3030, 0x06);	//RAW 10
 S5K4E1GA_write_cmos_sensor(0x3030, 0x05); //20121024  07
 //////////////////////////////////////////////////
...
UINT32 S5K4E1GAGetSensorID(UINT32 *sensorID) 
{
	...
	printk("S5K4E1GAGetSensorID enter :\n ");
	S5K4E1GA_write_cmos_sensor(0x0103,0x01);// Reset sensor
    mDELAY(10);
	...
	printk("[SENSOR-HONGZHE]S5K4E1GAGetSensorID get id = %x \n ", *sensorID);
#if 0 //hongzhe.liu for multi address check
    if (*sensorID != S5K4E1GA_SENSOR_ID) {

		printk("S5K4E1GAGetSensorID enter 2 :\n ");
		S5K4E1GA_write_cmos_sensor_v2(0x0103,0x01);// Reset sensor
	    mDELAY(10);

	    // check if sensor ID correct
	    do {
	        *sensorID = (S5K4E1GA_read_cmos_sensor_v2(0x0000)<<8)|S5K4E1GA_read_cmos_sensor_v2(0x0001);    
	        if (*sensorID == S5K4E1GA_SENSOR_ID)
	        	{
	        		printk("[SENSOR-HONGZHE 2]Sensor ID = 0x%04x\n", *sensorID);
	            	break;
	        	}
	        printk("[SENSOR-HONGZHE 2]Read Sensor ID Fail = 0x%04x\n", *sensorID);
	        retry--;
	    } while (retry > 0);
	    ...
	    S5K4E1GA_WRITE_ID = S5K4E1GA_WRITE_ID_2;
	    S5K4E1GA_READ_ID = S5K4E1GA_WRITE_ID_2+1;

    }
#else
	    if (*sensorID != S5K4E1GA_SENSOR_ID) {
	        *sensorID = 0xFFFFFFFF;
	        return ERROR_NONE;//ERROR_SENSOR_CONNECT_FAIL;
	    }
#endif
    return ERROR_NONE;
}
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	////add this debug code for test HDR
...
UINT32 S5K4E1GAGetResolution(MSDK_SENSOR_RESOLUTION_INFO_STRUCT *pSensorResolution)
{
	...
	pSensorResolution->SensorPreviewWidth	= S5K4E1GA_IMAGE_SENSOR_PV_WIDTH;
    	...
    	pSensorResolution->SensorPreviewHeight	= (S5K4E1GA_IMAGE_SENSOR_FULL_HEIGHT-6); //S5K4E1GAMIPI_REAL_PV_HEIGHT;
    #endif
   	 pSensorResolution->SensorFullWidth		= (S5K4E1GA_IMAGE_SENSOR_FULL_WIDTH-4-8); //S5K4E1GAMIPI_REAL_CAP_WIDTH;
 	pSensorResolution->SensorFullHeight		= (S5K4E1GA_IMAGE_SENSOR_FULL_HEIGHT-6); //S5K4E1GAMIPI_REAL_CAP_HEIGHT;
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
		...
		pSensorInfo->SensorPreviewResolutionY=(S5K4E1GA_IMAGE_SENSOR_FULL_HEIGHT-6) ;//S5K4E1GAMIPI_REAL_CAP_HEIGHT;
		pSensorInfo->SensorCameraPreviewFrameRate=15;
	#endif
	pSensorInfo->SensorFullResolutionX= (S5K4E1GA_IMAGE_SENSOR_FULL_WIDTH-4-8);
   	 pSensorInfo->SensorFullResolutionY= (S5K4E1GA_IMAGE_SENSOR_FULL_HEIGHT-6);
	...
	{
		case IMAGE_NORMAL: 
			 pSensorInfo->SensorOutputDataFormat = SENSOR_OUTPUT_FORMAT_RAW_B;  //define R
			 break;
		case IMAGE_H_MIRROR: 
                                                                ...
                                                                UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
    ...
    switch (FeatureId)
    {
        case SENSOR_FEATURE_GET_RESOLUTION:
            ...
            *pFeatureReturnPara16= (S5K4E1GA_IMAGE_SENSOR_FULL_HEIGHT-6);
            *pFeatureParaLen=4;
            break;
        case SENSOR_FEATURE_GET_PERIOD:
			#if defined( S5K4E1GA_1M_SIZE_PREVIEW )
				#if 1 // hongzhe-dbg defined(MT6575) || defined(MT6577) 
