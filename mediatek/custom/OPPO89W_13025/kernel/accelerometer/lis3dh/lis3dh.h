...
#define GPIO_GSENSOR_EINT_PIN		GPIO34
...
#define LIS3DH_REG_CTL_REG5			0X24
#define LIS3DH_REG_CTL_REG6			0X25
...
#define GSENSOR_H_LACTIVE				0X02
#define GSENSOR_HIGHPASS_MODE			0X01
#define GSENSOR_LIR_INT1				0X08		// Latch interrupt request on INT1_SRC register
#define GSENSOR_INT1_MODE				0x80		// And combination of the interrupt events
#define GSENSOR_INT1_DESCRIPTION		0X0A		// Y up , X up
#define GSENSOR_INT1_THS_VALUE			0X04		// 0x10: 250mg
#define GSENSOR_INT1_DURATION_VALUE		0X01
