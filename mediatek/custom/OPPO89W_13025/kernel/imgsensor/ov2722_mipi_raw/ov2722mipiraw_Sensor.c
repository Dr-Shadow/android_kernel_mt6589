...
void OV2722MIPI_init()
{
	...
	OV2722MIPI_write_cmos_sensor(0x3503,0x07);//17
	...
	OV2722MIPI_write_cmos_sensor(0x3035,0x00);//hufeng change for 1 lane
	OV2722MIPI_write_cmos_sensor(0x3036,0x1e);
	//OV2722MIPI_write_cmos_sensor(0x3037,0x21);
	OV2722MIPI_write_cmos_sensor(0x3037,0xa1);//hufeng change for 1 lane
	...
	switch (ScenarioId)
	{
		...
		case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
		 case MSDK_SCENARIO_ID_CAMERA_ZSD:
			...
			OV2722MIPIPreview(pImageWindow, pSensorConfigData);//hufeng change for zsd mode
