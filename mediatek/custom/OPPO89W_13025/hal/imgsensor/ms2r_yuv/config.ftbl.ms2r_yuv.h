 ...
 *
 ******************************************************************************/
FTABLE_DEFINITION(SENSOR_DRVNAME_MS2R_YUV)
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
FTABLE_SCENE_INDEP()
    //==========================================================================
#if 1
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                "176x144",      "320x240",      "352x288",      "480x320",      "480x368", 		"640x360", 
                "640x480",      "720x480",      "800x450",		"800x480",      "800x600",      "864x480", 
                "960x540",      "1280x720" //,		"1280x960" /*OPPO mayugang deleted. 2013-7-29*/
            )
        ), 
    )
#endif
...
//==========================================================================
	...
	//Recording hint
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        KEY_AS_(CameraParameters::KEY_RECORDING_HINT),
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_(CameraParameters::FALSE),
            ITEM_AS_VALUES_(
